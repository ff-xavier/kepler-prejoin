...
RENAME_RULES = [
    ...
    (["Index (Detached)"], "HPI - Index (Detached)"),
    (["Benchmark (Detached)"], "HPI - Benchmark (Detached)"),
    (["YoY% (Detached)"], "HPI - YoY% (Detached)"),
    (["Index (Attached)"], "HPI - Index (Attached)"),
    (["Benchmark (Attached)"], "HPI - Benchmark (Attached)"),
    (["YoY% (Attached)"], "HPI - YoY% (Attached)"),
    (["Index (Townhouse)"], "HPI - Index (Townhouse)"),
    (["Benchmark (Townhouse)"], "HPI - Benchmark (Townhouse)"),
    (["YoY% (Townhouse)"], "HPI - YoY% (Townhouse)"),
